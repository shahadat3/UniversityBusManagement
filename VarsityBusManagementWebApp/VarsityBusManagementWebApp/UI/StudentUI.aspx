    ...
    <table>
        ...
        <tr>
          ...
          <tr>
            ...
            <td>
                <asp:TextBox ID="PasswordTextbox" TextMode="Password" placeholder="Enter Password" runat="server" Height="16px" Width="160px"></asp:TextBox>     
            </td>
              <td>
                <asp:TextBox ID="ConfirmpassTextbox" TextMode="Password" placeholder="Retype Password" runat="server" Height="16px" Width="160px"></asp:TextBox>     
            </td>
        </tr>
        <tr>
            <td></td>
